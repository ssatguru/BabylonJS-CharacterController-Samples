...
declare module BABYLON {
    ...
    export var DefaultXmlSerializerNumberOptions: Readonly<IXmlSerializerNumberOptions>;
    export var DefaultXmlSerializerFormatOptions: Readonly<IXmlSerializerFormatOptions>;
    /**
     *@param opts
     *@returns
     */
    export function ResolveNumberOptions(opts?: IXmlSerializerNumberOptions): Required<Omit<IXmlSerializerNumberOptions, "perAttributeEps" | "fixedDecimals" | "maxDecimalsCap" | "trimTrailingZeros" | "allowScientific" | "snapNearZero" | "zeroThreshold">> & Pick<IXmlSerializerNumberOptions, "perAttributeEps" | "fixedDecimals"> & {
        maxDecimalsCap: number;
        trimTrailingZeros: boolean;
        allowScientific: boolean;
        snapNearZero: boolean;
     ...
     * @returns
     */
    export function IsQualifiedName(x: unknown): x is {
        name: string;
    };
     ...
     * @returns
     */
    export function XmlIgnore(): (target: any, prop: string) => void;
    /**
